...
MODULES = ["json_dataset", "cp_targets", "metrics",
           "make_samples", "make_samples_feat", "make_samples_hard",
           "make_samples_varied", "step_to_json", "viz_preds",
           "detect_openings", "step_openings", "cp_regressor"]
